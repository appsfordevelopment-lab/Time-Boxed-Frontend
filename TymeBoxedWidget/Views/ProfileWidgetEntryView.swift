...
struct ProfileWidgetEntryView: View {
  ...
  private var linkToOpen: URL {
    ...
    if entry.isBreakActive || entry.isSessionActive {
      return URL(string: "https://timeboxed.app")!
    }

    return entry.deepLinkURL ?? URL(string: "timeboxed://")!
  }
...
#Preview(as: .systemSmall) {
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://timeboxed.app/profile/test-id"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://timeboxed.app/profile/\(activeProfileId.uuidString)"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://timeboxed.app/profile/\(breakProfileId.uuidString)"),
  ...
  ProfileWidgetEntry(
    ...
    activeSession: nil,
    profileSnapshot: nil,
    deepLinkURL: URL(string: "timeboxed://"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://timeboxed.app/profile/\(unavailableProfileId.uuidString)"),
