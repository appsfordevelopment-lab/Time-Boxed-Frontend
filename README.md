...
<h1 align="center"><a href="https://apps.apple.com/ca/app/timeboxed/id6736793117">Tyme Boxed</a></h1>
...
<p align="center">
  Tyme Boxed helps you put your most distracting apps behind a quick tap — using NFC tags or QR codes — so you can stay in the zone and build better digital habits. It’s free, open source, and an alternative to Brick, Bloom, Unpluq, Blok, and more.
</p>
...
1. Download Tyme Boxed from the [App Store](https://apps.apple.com/ca/app/timeboxed/id6736793117)
...
2. Create a profile in Tyme Boxed
...
- Each profile exposes a deep link via `BlockedProfiles.getProfileDeepLink(profile)` in the form:
  - `https://timeboxed.app/profile/<PROFILE_UUID>`
...
- **Bug Reports**: [Open an issue](https://github.com/awaseem/timeboxed/issues) with detailed steps to reproduce
- **Feature Requests**: Share your ideas via [GitHub Issues](https://github.com/awaseem/timeboxed/issues)
...
- [App Store](https://apps.apple.com/ca/app/timeboxed/id6736793117)
- [GitHub Issues](https://github.com/awaseem/timeboxed/issues)
- [Support the Project](https://apps.apple.com/ca/app/timeboxed/id6736793117) (via in-app purchases or [here](https://coff.ee/ambitionsoftware))
